    ...
    return (
        <>
            ...
            <main>
                <section id="sobre">
                    <div className="eu">
                        <img src="ASSETS\imagens\Foto de Braian de Liz (1).jpg" alt="Braian" className='imge'/>
                        <div>
...
function App() {
    return (
        <Router>
            <div className="App">
                <a href="https://github.com/Braian-de-Liz" target="_blank" rel="noopener noreferrer" className="github-floating">
