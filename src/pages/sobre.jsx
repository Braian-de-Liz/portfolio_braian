    ...
    return (
        <main>
                ...
                <div className="curriculo-perfil">
                    ...
                    <div className="curriculo-info">
                        ...
                        <p className="curriculo-descricao">
                            Sou desenvolvedor focado em backend e no ecossistema TypeScript/JavaScript.
                            Construo aplicações robustas com foco em performance  do schema validation ao deploy.
                            Especializado em Bun, Node.js, Fastify e React, com experiência em microsserviços em Go e bancos relacionais.
                        </p>
            ...
            <section className="cont">
                <h2 className="titulo">Formação Técnica</h2>
                ...
                <div className="trajetoria-divider"></div>

                <div className="trajetoria-item">
                    <div className="exibir-form">
                        <h3>Técnico em Desenvolvimento de Sistemas</h3>
                        <img loading="lazy" src="ASSETS/imagens/certificado_EM.png" alt="Certificado Técnico" />
                        <h4>Curso Técnico de 2 anos, integrado ao Ensino Médio da Escola SESI de Referência Joinville.</h4>
                        <a
            ...
            <section className="cont">
                <h2 className="titulo">Experiências & Voluntariado</h2>
            ...
            <section className="cont">
                <h2 className="titulo">Educação</h2>
